...
//alors vous pouvre écrire quelquechose comme :
$acteurs = get_post_meta($post->ID, 'interprete', true);
...
//Si vous avez saisi les prix obtenus
//dans un champs personnalisé
//que vous avez nommé 'prix',
//alors vous pouvre écrire quelquechose comme :
$prix = get_post_meta($post->ID, 'prix', true);
//Si vous avez saisi le genre
//dans un champs personnalisé
//que vous avez nommé 'genre',
//alors vous pouvre écrire quelquechose comme :
...
<span class="champs-persos-item">
<i class=”champs-persos-label”>prix obtenu : </i>
<?php echo $prix ?></span>
<?php endif; ?>
</div> <!-- .champs-perso -->
